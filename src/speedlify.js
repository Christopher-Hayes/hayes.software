...
function renderHTML(d) {
  ...
  return html`
    <div
      class="mt-8 flex w-full flex-col divide-y divide-bg-raised border-t border-bg-raised text-sm"
    >
      <div class="flex divide-x divide-bg-raised">
      ...
      <div class="flex w-full divide-x divide-bg-raised text-fg">
