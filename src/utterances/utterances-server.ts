...
console.log('Running utterances.ts');

// setRepoContext(page);

// @ts-ignore-next-line
// window.initUtterances = function initUtterances(owner: string, repo: string) {
  // setRepoContext({ owner, repo });
// };

// @ts-ignore-next-line
// window.initUtterances('Christopher-Hayes', 'hayes.software');

setRepoContext({
  owner: 'Christopher-Hayes',
  repo: 'hayes.software'
});
