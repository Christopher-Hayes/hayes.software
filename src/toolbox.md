...
## <span class="text-primary dark:text-fg inline-block py-1 px-2 bg-primary bg-opacity-10 dark:bg-bg-raised dark:bg-opacity-10 rounded-md font-bold">ubuntu 22.04</span>
...
## <span class="text-primary dark:text-fg inline-block py-1 px-2 bg-primary bg-opacity-10 dark:bg-bg-raised dark:bg-opacity-10 rounded-md font-bold">terminal sanity</span>
...
## <span class="text-primary dark:text-fg inline-block py-1 px-2 bg-primary bg-opacity-10 dark:bg-bg-raised dark:bg-opacity-10 rounded-md font-bold">mac</span>
